...
-- -----------------------------------------------------
-- Schema kx15nbovban3cm41
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema kx15nbovban3cm41
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `kx15nbovban3cm41` DEFAULT CHARACTER SET utf8 ;
USE `kx15nbovban3cm41` ;

-- -----------------------------------------------------
-- Table `kx15nbovban3cm41`.`member`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kx15nbovban3cm41`.`member` (
...
-- -----------------------------------------------------
-- Table `kx15nbovban3cm41`.`product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kx15nbovban3cm41`.`product` (
  `num` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `kx15nbovban3cm41`.`product_tag`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kx15nbovban3cm41`.`product_tag` (
  `num` INT NOT NULL AUTO_INCREMENT,
  `pnum` INT NOT NULL,
  ...
  CONSTRAINT `fk_tag_product`
    FOREIGN KEY (`pnum`)
    REFERENCES `kx15nbovban3cm41`.`product` (`num`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `kx15nbovban3cm41`.`comment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kx15nbovban3cm41`.`comment` (
  `num` INT NOT NULL AUTO_INCREMENT,
  `mnum` INT NOT NULL,
  `pnum` INT NOT NULL,
  ...
  CONSTRAINT `fk_comment_member1`
    FOREIGN KEY (`mnum`)
    REFERENCES `kx15nbovban3cm41`.`member` (`num`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `kx15nbovban3cm41`.`comment_tag`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kx15nbovban3cm41`.`comment_tag` (
  `num` INT NOT NULL AUTO_INCREMENT,
  `cnum` INT NOT NULL,
  `pnum` INT NOT NULL,
  `content` VARCHAR(45) NULL DEFAULT '',
  ...
  CONSTRAINT `fk_tag_copy1_comment1`
    FOREIGN KEY (`cnum`)
    REFERENCES `kx15nbovban3cm41`.`comment` (`num`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `kx15nbovban3cm41`.`like`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kx15nbovban3cm41`.`like` (
  `num` INT NOT NULL AUTO_INCREMENT,
  `mnum` INT NOT NULL,
  `pnum` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `kx15nbovban3cm41`.`cart`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kx15nbovban3cm41`.`cart` (
  `num` INT NOT NULL AUTO_INCREMENT,
  `mnum` INT NOT NULL,
  `pnum` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `kx15nbovban3cm41`.`productimg`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kx15nbovban3cm41`.`productimg` (
  `num` INT NOT NULL AUTO_INCREMENT,
  `pnum` INT NOT NULL,
